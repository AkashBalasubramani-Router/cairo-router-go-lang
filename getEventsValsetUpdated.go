...
// 		var _newValsetNonce, _eventNonce *big.Int

// 		var _validators []common.Address
// 		var _powers []uint64
...
// 				switch i {
// 				case 0:
// 					_newValsetNonce = combinedBigInt
// 				case 2:
// 					_eventNonce = combinedBigInt
// 				}
...
// 			arraySize1.SetString(emittedEvent.Event.Data[5].String(), 0)
// 			// fmt.Println("Array size 2", arraySize1)

// 			// Construct arrayValue1 based on arraySize1
// 			arrayValue1 := make([]common.Address, arraySize1.Int64())
// 			for j := 0; j < int(arraySize1.Int64()); j++ {
// 				value := emittedEvent.Event.Data[6+j].String()
// 				finalValue := common.HexToAddress(value)

// 				arrayValue1[j] = finalValue
// 			}

// 			_validators = arrayValue1

// 			arraySize2 := new(big.Int)
// 			arraySize2.SetString(emittedEvent.Event.Data[5+arraySize1.Int64()+1].String(), 0)

// 			arrayValue2 := make([]uint64, arraySize1.Int64())
// 			for j := 0; j < int(arraySize2.Int64()); j++ {
// 				stringVariable7Int := emittedEvent.Event.Data[6+arraySize1.Int64()+1+int64(j)].String()[2:] // Removing "0x" prefix
// 				uint64Value, err := strconv.ParseUint(stringVariable7Int, 16, 64)
// 				if err != nil {
// 					fmt.Println("Error:", err)
// 					return
// 				}

// 				arrayValue2[j] = uint64Value
// 			}
...
// 			fmt.Println("_newValsetNonce:", _newValsetNonce)
// 			fmt.Println("_eventNonce:", _eventNonce)
// 			// fmt.Println("relayerRouterAddress:", relayerRouterAddress)
// 			fmt.Println("srcChainId:", SrcChainId)
// 			fmt.Println("_validators:", _validators)

// 			fmt.Println("_powers:", _powers)
