...
// func serializing(IReceive_method_name string, route_amount *big.Int, requestIdentifier *big.Int, requestTimestamp *big.Int, srcchainId string, route_recipient string, destchainId string, asmaddress string, requestSender string, handleraddress string, packet []string, isReadcall bool, MSG_PREFIX string) {
// 	var serializedData []string
// 	// serialized_Ireceive := stringToHex(IReceive_method_name)
// 	serializedData = append(serializedData, "0x0")
